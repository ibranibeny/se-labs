...
solution_areas: [CAIP]
asset_type: "Workshop"
products: [Azure Arc, SQL Server, Windows Server, Azure Monitor, Governance]
---
...
This module takes you from zero knowledge to a fully scripted hands-on lab, in four
progressive levels (L100 → L400). Beginners can start at L100; experienced
